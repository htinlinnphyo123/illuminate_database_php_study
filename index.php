    ...
    <div class="container">
        <div class="row">
            <div class="col-10 mx-auto mt-4">
                <a href="/create.php" class="btn btn-primary rounded-sm">Add Beers</a>
                ...
                <table class="table bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="./editPage.php?id=<?php echo $beer->id ?>" class="btn btn-primary">Edit</a>
                                <a href="./app/service/delete.php?id=<?php echo $beer->id ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
